...
public class TeXParser {
    ...
    private static readonly char L_GROUP = '{';
    private static readonly char R_GROUP = '}';
    private static readonly char L_BRACK = '[';
    private static readonly char R_BRACK = ']';
    private static readonly char DOLLAR = '$';
    private static readonly char DQUOTE = '\"';

    // Percent char for comments
    private static readonly char PERCENT = '%';

    // script characters (for parsing)
    private static readonly char SUB_SCRIPT = '_';
    private static readonly char SUPER_SCRIPT = '^';
    private static readonly char PRIME = '\'';
    private static readonly char BACKPRIME = '\u2035';
    private static readonly char DEGRE = '\u00B0';
    private static readonly char SUPZERO = '\u2070';
    private static readonly char SUPONE = '\u00B9';
    private static readonly char SUPTWO = '\u00B2';
    private static readonly char SUPTHREE = '\u00B3';
    private static readonly char SUPFOUR = '\u2074';
    private static readonly char SUPFIVE = '\u2075';
    private static readonly char SUPSIX = '\u2076';
    private static readonly char SUPSEVEN = '\u2077';
    private static readonly char SUPEIGHT = '\u2078';
    private static readonly char SUPNINE = '\u2079';
    private static readonly char SUPPLUS = '\u207A';
    private static readonly char SUPMINUS = '\u207B';
    private static readonly char SUPEQUAL = '\u207C';
    private static readonly char SUPLPAR = '\u207D';
    private static readonly char SUPRPAR = '\u207E';
    private static readonly char SUPN = '\u207F';
    private static readonly char SUBZERO = '\u2080';
    private static readonly char SUBONE = '\u2081';
    private static readonly char SUBTWO = '\u2082';
    private static readonly char SUBTHREE = '\u2083';
    private static readonly char SUBFOUR = '\u2084';
    private static readonly char SUBFIVE = '\u2085';
    private static readonly char SUBSIX = '\u2086';
    private static readonly char SUBSEVEN = '\u2087';
    private static readonly char SUBEIGHT = '\u2088';
    private static readonly char SUBNINE = '\u2089';
    private static readonly char SUBPLUS = '\u208A';
    private static readonly char SUBMINUS = '\u208B';
    private static readonly char SUBEQUAL = '\u208C';
    private static readonly char SUBLPAR = '\u208D';
    private static readonly char SUBRPAR = '\u208E';
    ...
    public Atom convertCharacter(char c, bool oneChar)  {
        ...
        if (((c < '0' || c > '9') && (c < 'a' || c > 'z') && (c < 'A' || c > 'Z'))) {
            ...
            if (symbolName == null && (TeXFormula.symbolFormulaMappings == null || TeXFormula.symbolFormulaMappings[c] == null)) {
                ...
                bool isLatin = Character.UnicodeBlock.BASIC_LATIN.equals(block);
