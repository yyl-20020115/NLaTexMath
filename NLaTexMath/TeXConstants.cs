...
public class TeXConstants {
     ...
     */
    public static readonly int ALIGN_RIGHT = 1;
     ...
     */
    public static readonly int ALIGN_CENTER = 2;

    /**
     * Alignment constant: extra space will be added under the formula
     */
    public static readonly int ALIGN_TOP = 3;

    /**
     * Alignment constant: extra space will be added above the formula
     */
    public static readonly int ALIGN_BOTTOM = 4;

    /**
     * Alignment constant: none
     */
    public static readonly int ALIGN_NONE = 5;

    public static readonly int THINMUSKIP = 1;
    public static readonly int MEDMUSKIP = 2;
    public static readonly int THICKMUSKIP = 3;
    public static readonly int NEGTHINMUSKIP = -1;
    public static readonly int NEGMEDMUSKIP = -2;
    public static readonly int NEGTHICKMUSKIP = -3;

    public static readonly int QUAD = 3;

    public static readonly int SCRIPT_NORMAL = 0;
    public static readonly int SCRIPT_NOLIMITS = 1;
    public static readonly int SCRIPT_LIMITS = 2;
     ...
     */
    public static readonly int TYPE_ORDINARY = 0;

    /**
     * Symbol/Atom type: big operator (= large operator), e.g. "sum"
     */
    public static readonly int TYPE_BIG_OPERATOR = 1;

    /**
     * Symbol/Atom type: binary operator, e.g. "plus"
     */
    public static readonly int TYPE_BINARY_OPERATOR = 2;

    /**
     * Symbol/Atom type: relation, e.g. "equals"
     */
    public static readonly int TYPE_RELATION = 3;

    /**
     * Symbol/Atom type: opening symbol, e.g. "lbrace"
     */
    public static readonly int TYPE_OPENING = 4;

    /**
     * Symbol/Atom type: closing symbol, e.g. "rbrace"
     */
    public static readonly int TYPE_CLOSING = 5;

    /**
     * Symbol/Atom type: punctuation symbol, e.g. "comma"
     */
    public static readonly int TYPE_PUNCTUATION = 6;

    /**
     * Atom type: inner atom (NOT FOR SYMBOLS!!!)
     */
    public static readonly int TYPE_INNER = 7;

    /**
     * Symbol type: accent, e.g. "hat"
     */
    public static readonly int TYPE_ACCENT = 10;

    public static readonly int TYPE_INTERTEXT = 11;

    public static readonly int TYPE_MULTICOLUMN = 12;

    public static readonly int TYPE_HLINE = 13;
     ...
     */
    public static readonly int DELIM_BRACE = 0;

    /**
     * Delimiter type constant for putting delimiters over and under formula's: square bracket
     */
    public static readonly int DELIM_SQUARE_BRACKET = 1;

    /**
     * Delimiter type constant for putting delimiters over and under formula's: parenthesis
     */
    public static readonly int DELIM_BRACKET = 2;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with single line pointing to the left
     */
    public static readonly int DELIM_LEFT_ARROW = 3;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with single line pointing to the right
     */
    public static readonly int DELIM_RIGHT_ARROW = 4;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with single line pointing to the left and to the right
     */
    public static readonly int DELIM_LEFT_RIGHT_ARROW = 5;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with two lines pointing to the left
     */
    public static readonly int DELIM_DOUBLE_LEFT_ARROW = 6;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with two lines pointing to the right
     */
    public static readonly int DELIM_DOUBLE_RIGHT_ARROW = 7;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * arrow with two lines pointing to the left and to the right
     */
    public static readonly int DELIM_DOUBLE_LEFT_RIGHT_ARROW = 8;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * underline once
     */
    public static readonly int DELIM_SINGLE_LINE = 9;

    /**
     * Delimiter type constant for putting delimiters over and under formula's:
     * underline twice
     */
    public static readonly int DELIM_DOUBLE_LINE = 10;
     ...
     */
    public static readonly int STYLE_DISPLAY = 0;
     ...
     */
    public static readonly int STYLE_TEXT = 2;
     ...
     */
    public static readonly int STYLE_SCRIPT = 4;
     ...
     */
    public static readonly int STYLE_SCRIPT_SCRIPT = 6;
     ...
     */
    public static readonly int UNIT_EM = 0;
     ...
     */
    public static readonly int UNIT_EX = 1;

    /**
     * Unit constant: pixel
     */
    public static readonly int UNIT_PIXEL = 2;

    /**
     * Unit constant: postscript point
     */
    public static readonly int UNIT_POINT = 3;
     ...
     * 1 pica = 12 point
     */
    public static readonly int UNIT_PICA = 4;
     ...
     */
    public static readonly int UNIT_MU = 5;
     ...
     */
    public static readonly int UNIT_CM = 6;
     ...
     */
    public static readonly int UNIT_MM = 7;
     ...
     * 1 in = 72 point
     */
    public static readonly int UNIT_IN = 8;
     ...
     * 1 sp = 65536 point
     */
    public static readonly int UNIT_SP = 9;
     ...
     * 1 in = 72.27 pt
     */
    public static readonly int UNIT_PT = 10;
     ...
     * 1 in = 72 point
     */
    public static readonly int UNIT_DD = 11;
     ...
     * 1 in = 72 point
     */
    public static readonly int UNIT_CC = 12;
     ...
     */
    public static readonly int UNIT_X8 = 13;
}
