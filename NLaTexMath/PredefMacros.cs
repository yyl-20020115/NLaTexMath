...
public class PredefMacros {
    ...
    public static  Atom textstyle_macros( TeXParser tp,  string[] args)  {
        ...
        if (fontInfos != null) {
            TeXFormula.externalFontMap.Add(Character.UnicodeBlock.BASIC_LATIN, null);
        }
        Atom at = new TeXFormula(tp, args[1], false).root;
        if (fontInfos != null) {
            TeXFormula.externalFontMap.Add(Character.UnicodeBlock.BASIC_LATIN, fontInfos);
        }
